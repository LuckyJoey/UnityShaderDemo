...
Shader "Joey/06 MyShader-Specular"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                vf.worldNormalDir = normalize(mul(v.normal,(float3x3)unity_WorldToObject));
